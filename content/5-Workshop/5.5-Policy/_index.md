...
![endpoint diagram](/ThuctapAWS/images/5-Workshop/5.5-Policy/s3-bucket-policy.png)
...
```
![test](/ThuctapAWS/images/5-Workshop/5.5-Policy/test1.png)
...
![create bucket](/ThuctapAWS/images/5-Workshop/5.5-Policy/create-bucket.png)

Successfully create bucket

![Success](/ThuctapAWS/images/5-Workshop/5.5-Policy/create-bucket-success.png)
...
![policy](/ThuctapAWS/images/5-Workshop/5.5-Policy/policy1.png)
...
![custom policy](/ThuctapAWS/images/5-Workshop/5.5-Policy/policy2.png)

Successfully customize policy

![success](/static/ThuctapAWS/images/5-Workshop/5.5-Policy/success.png)
...
![error](/static/ThuctapAWS/images/5-Workshop/5.5-Policy/error.png)
...
![success](/static/ThuctapAWS/images/5-Workshop/5.5-Policy/test2.png)

This operation succeeds because it is permitted by the VPC endpoint policy.

![success](/static/ThuctapAWS/images/5-Workshop/5.5-Policy/test2-success.png)
...
![fail](/static/ThuctapAWS/images/5-Workshop/5.5-Policy/test2-fail.png)
