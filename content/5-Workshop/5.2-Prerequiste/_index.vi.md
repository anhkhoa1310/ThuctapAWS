...
![create stack](/ThuctapAWS/images/5-Workshop/5.2-Prerequisite/create-stack1.png)

+ Lựa chọn 2 mục acknowledgement 
+ Chọn Create stack

![create stack](/ThuctapAWS/images/5-Workshop/5.2-Prerequisite/create-stack2.png)

Quá trình triển khai CloudFormation cần khoảng 15 phút để hoàn thành.

![complete](/ThuctapAWS/images/5-Workshop/5.2-Prerequisite/complete.png)

+ 2 VPCs đã được tạo

![vpcs](/ThuctapAWS/images/5-Workshop/5.2-Prerequisite/vpcs.png)

+ 3 EC2s đã được tạo

![EC2](/ThuctapAWS/images/5-Workshop/5.2-Prerequisite/ec2.png)