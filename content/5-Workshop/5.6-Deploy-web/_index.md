...
6. Wait until the status changes from `In progress` to `Completed`.
   ...
   ![Create a CloudFront Invalidation after updating the frontend](/images/5-Workshop/5.6-deploy-web/deploy6.jpg)
...
8. Click **Save changes**.
   ...
   ![Update callback and sign-out URLs in Amazon Cognito](/images/5-Workshop/5.6-deploy-web/deploy7.jpg)
