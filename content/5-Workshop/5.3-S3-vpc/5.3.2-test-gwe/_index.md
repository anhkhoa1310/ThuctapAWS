...
![Create bucket](/ThuctapAWS/images/5-Workshop/5.3-S3-vpc/create-bucket.png)
...
![Bucket name](/ThuctapAWS/images/5-Workshop/5.3-S3-vpc/bucket-name.png)

+ Leave other fields as they are (default)
+ Scroll down and choose **Create bucket**

![Create](/ThuctapAWS/images/5-Workshop/5.3-S3-vpc/create-button.png) 

+ Successfully create S3 bucket.

![Success](/ThuctapAWS/images/5-Workshop/5.3-S3-vpc/bucket-success.png)
...
![system manager](/ThuctapAWS/images/5-Workshop/5.3-S3-vpc/sm.png)

2. From the **Systems Manager** menu, find **Node Management** in the left menu and click **Session Manager**:

![system manager](/ThuctapAWS/images/5-Workshop/5.3-S3-vpc/sm1.png)
...
![Start session](/ThuctapAWS/images/5-Workshop/5.3-S3-vpc/start-session.png)

**Session Manager** will open a new browser tab with a shell prompt: sh-4.2 $

![Success](/ThuctapAWS/images/5-Workshop/5.3-S3-vpc/start-session-success.png)
...
![Change user's dir](/ThuctapAWS/images/5-Workshop/5.3-S3-vpc/cli1.png)
...
![Create file](/ThuctapAWS/images/5-Workshop/5.3-S3-vpc/cli-file.png)
...
![Uploaded](/ThuctapAWS/images/5-Workshop/5.3-S3-vpc/uploaded.png)
...
![Check S3](/ThuctapAWS/images/5-Workshop/5.3-S3-vpc/check-s3-bucket.png)
