...
![route 53 diagram](/ThuctapAWS/images/5-Workshop/5.4-S3-onprem/route53.png)
...
![Create stack](/ThuctapAWS/images/5-Workshop/5.4-S3-onprem/create-stack.png)

![Button](/ThuctapAWS/images/5-Workshop/5.4-S3-onprem/create-stack-button.png)
...
![ec2 id](/ThuctapAWS/images/5-Workshop/5.4-S3-onprem/ec2-onprem-id.png)
...
![rt](/ThuctapAWS/images/5-Workshop/5.4-S3-onprem/rt.png)

5. Click Add route.
+ Destination: your Cloud VPC cidr range
+ Target: ID of your infra-vpngw-test instance (you saved in your editor at step 1)

![add route](/ThuctapAWS/images/5-Workshop/5.4-S3-onprem/add-route.png)
