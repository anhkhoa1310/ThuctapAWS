...
Si votre favicon est un png, déposez votre image dans votre dossier local `static/ThuctapAWS/images/` et nommez le `favicon.png`
...
```html
<link rel="shortcut icon" href="/ThuctapAWS/images/favicon.png" type="image/x-icon" />
```
...
![Variante rouge](/en/basics/style-customization/ThuctapAWS/images/red-variant.png?width=60pc)
...
![Variante bleue](/en/basics/style-customization/ThuctapAWS/images/blue-variant.png?width=60pc)
...
![Variante verte](/en/basics/style-customization/ThuctapAWS/images/green-variant.png?width=60pc)
